...
file_path = "gs://retailstore-bucket/retail.py#" 
...
df_grouped_by_country.write.csv("gs://retailstore-bucket/retail.py/average_salary_by_country", header=True)
...
df_grouped_by_gender.write.csv("gs://retailstore-bucket/retail.py/gender_distribution", header=True)
...
average_age_df.write.csv("gs://retailstore-bucket/retail.py/average_age.csv", header=True)
...
df_grouped_by_country_customers.write.csv("gs://retailstore-bucket/retail.py/total_customers_by_country", header=True)
...
df_grouped_by_country_salary.write.csv("gs://retailstore-bucket/retail.py/top_5_countries_by_salary_spend", header=True)
